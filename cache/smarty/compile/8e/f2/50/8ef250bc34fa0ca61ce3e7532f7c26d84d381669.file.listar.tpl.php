<?php /* Smarty version Smarty-3.1.19, created on 2022-11-03 18:11:36
         compiled from "/var/www/html/modules/usuario/views/templates/front/listar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10713631366363f648e11ed2-86850255%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10713631366363f648e11ed2-86850255',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6363f648e6fb56_33227610',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6363f648e6fb56_33227610')) {function content_6363f648e6fb56_33227610($_smarty_tpl) {?><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
...
')">
 ...
 <?php echo $_smarty_tpl->tpl_vars['usuario']->value[0]['lastname'];?>
</h3><h4><?php echo $_smarty_tpl->tpl_vars['usuario']->value[0]['description'];?>
</h4><p><?php echo $_smarty_tpl->tpl_vars['usuario']->value[0]['genre'];?>
</p></div>
            </div>
...
" class="d-block w-100" alt="" onclick="showInformation('<?php echo $_smarty_tpl->tpl_vars['u']->value['name'];?>
', '<?php echo $_smarty_tpl->tpl_vars['u']->value['lastname'];?>
', '<?php echo $_smarty_tpl->tpl_vars['u']->value['description'];?>
', '<?php echo $_smarty_tpl->tpl_vars['u']->value['genre'];?>
')">
                    <div class="carousel-caption"><h3><?php echo $_smarty_tpl->tpl_vars['u']->value['name'];?>
 <?php echo $_smarty_tpl->tpl_vars['u']->value['lastname'];?>
</h3><h4><?php echo $_smarty_tpl->tpl_vars['u']->value['description'];?>
</h4><p><?php echo $_smarty_tpl->tpl_vars['u']->value['genre'];?>
</p></div>
                </div>
            <?php } ?>
        </div>
